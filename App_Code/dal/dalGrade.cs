...
public class dalGrade
{
    ...
    public int Insert(string gradeName, double gradePoint, double starMarks, double endMarks)
    {
    ...
    public int Update(int id,string gradeName, double gradePoint, double starMarks, double endMarks)
    {
