<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ClassRoutine.aspx.cs" Inherits="Pages_Student_ClassRoutine" %>
    ...
    <div class='<%= Common.SessionInfo.Panel %>' id="criteria">
        ...
        <div class="panel-footer">
            <asp:Button ID="btnShowRoutine" runat="server" CssClass="btn btn-flat btn-success"
                Text="Show Class Routine"  OnClick="btnShowRoutine_Click" />
        </div>
    </div>
