<%@ Page Title="Payment History" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="PaidHistory.aspx.cs" Inherits="Pages_Student_PaidHistory" %>
                            ...
                            <table id="dtPayment" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <asp:Label ID="Label14" runat="server" Text="TransactionID"></asp:Label></th>
                                    </tr>
                                </thead>
                                <tbody>
                        </HeaderTemplate>
