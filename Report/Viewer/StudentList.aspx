<%@ Page Title="Student List" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="StudentList.aspx.cs" Inherits="Report_Viewer_StudentList" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4">
                                    <asp:Label ID="Label19" runat="server" Text="Promotion Status"></asp:Label><span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <asp:DropDownList ID="ddlPromotion" runat="server" CssClass="form-control dropdown">
                                        <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                        <asp:ListItem Text="Promoted" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Not-Promoted" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel panel-success">
                <div class="panel-body">
                    <asp:Repeater ID="rpt" runat="server">
                        <HeaderTemplate>
                            <table id="dtprint" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>
                                        ...
                                        <th>
                                            <asp:Label ID="Label14" runat="server" Text="<%$ Resources:Application,Section %>"></asp:Label></th>
                                        <th>
                                            <asp:Label ID="Label15" runat="server" Text="<%$ Resources:Application,Shift %>"></asp:Label></th>
                                    </tr>
                                </thead>
                                <tbody>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("NameEng") %><br /><%#Eval("NameBan") %></td>
                                <td><%#Eval("Mobile") %></td>
                                <td><%#Eval("Gender") %></td>
                                <td><%#Eval("Religion") %></td>
                                <td><%#Eval("Class") %></td>
