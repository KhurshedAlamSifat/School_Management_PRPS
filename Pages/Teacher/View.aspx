<%@ Page Title="Teacher's Details" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Pages_Student_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="mainbody">
        ...
        <div class="panel panel-success">
            <div class="panel-body">
                <table class="table-responsive table-bordered table">
                    <tr>
                        <td>
                            <asp:Label ID="Label15" runat="server" Text="<%$ Resources:Application,TeacherPINNo %>"></asp:Label></td>
                        <td>
                            <asp:Label ID="lblRegNo" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Application,Email %>"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Application,JoinDate %>"></asp:Label></td>
                        <td>
                            <asp:Label ID="lblJoinDate" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:Application,Mobile %>"></asp:Label></td>
                        <td>
                    ...
                    <div class="col-sm-10">
                        <table class="table-responsive table-bordered table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label26" runat="server" Text="<%$ Resources:Application,NationalIdNo %>"></asp:Label></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><asp:Label ID="Label38" runat="server" Text="<%$ Resources:Application,Designation %>"></asp:Label></td>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Mother's Photo"></asp:Label>
                    </div>
                    <div class="col-sm-10">
                        <table class="table-responsive table-bordered table">
                            <tr>
        ...
        <div class="panel panel-success">
            <div class="panel-body">
                <asp:GridView ID="gvEducation" ClientIDMode="Static" CssClass="table" runat="server" AutoGenerateColumns="true">
                </asp:GridView>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-body">
                <asp:GridView ID="gvTraining" ClientIDMode="Static" CssClass="table" runat="server" AutoGenerateColumns="true">
                </asp:GridView>
            </div>
        </div>
