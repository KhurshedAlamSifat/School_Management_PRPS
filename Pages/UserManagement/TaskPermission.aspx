<%@ Page Title="<%$ Resources:Application,TaskToRole %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="TaskPermission.aspx.cs" Inherits="Pages_RoleManagement_TaskPermission" %>
