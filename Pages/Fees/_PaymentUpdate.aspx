<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="_PaymentUpdate.aspx.cs" Inherits="Pages_Fees_PaymentUpdate" %>
                                    ...
                                    <asp:Repeater ID="rptDues" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("Amount") %></td>
                                                <td>
                                                    <asp:ImageButton ID="btnEdit" runat="server" OnCommand="btnEdit_Command" CommandArgument='<%# Eval("PaymentId")%>' ImageUrl="~/Images/Common/edit.png" ToolTip="Edit" />
                                                    <asp:ImageButton ID="btnDelete" runat="server" OnCommand="btnDelete_Command" CommandArgument='<%# Eval("PaymentId")%>' ImageUrl="~/Images/Common/delete.png" ToolTip="Delete" OnClientClick="return confirm('Are you sure?')" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
                ...
                <div class="col-sm-4 form">
                    <div class='<%= Common.SessionInfo.Panel %>'>
                        <div class="panel-heading" id="hideheading">
                            <asp:Label ID="Label7" runat="server" Text="Fee Details"></asp:Label>
                        </div>
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-10">FeeType</label>
                                    <div class="col-md-12">
                                        <asp:DropDownList ID="ddlFeeType" runat="server" DataTextField="PaymentType" DataValueField="Id" CssClass="form-control dropdown"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-10">Paid Amount</label>
                                    <div class="col-md-12">
                                        <asp:TextBox ID="tbxPaid" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-7">Dues</label>
                                    <div class="col-md-12">
                                        <asp:TextBox ID="tbxDues" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-footer">
                            <div class="row" style="padding-top: 5px;">
                                <div class="col-sm-6">
                                    <asp:Button ID="btnSave" runat="server" Text="Save" class="btn btn-flat btn-primary" OnClick="btnSave_Click" />
                                </div>
                            </div>
