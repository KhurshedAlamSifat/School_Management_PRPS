<%@ Page Title="Special Fees" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="FeeCorrection.aspx.cs" Inherits="Pages_Fees_FeeCorrection" %>
                    ...
                    <div class='<%= Common.SessionInfo.Panel %>'>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-7">Bulk Upload</label>
                                    <label class="col-md-5 text-right"><a href="../../Content/FeeSample.xlsx">Bulk Sample</a></label>
                                    <div class="col-md-12">
                                        <asp:FileUpload ID="flBulkUpload" runat="server" />
                        ...
                        <div class="panel panel-footer">
                            <div class="row" style="padding-top: 5px;">
                                <div class="col-sm-6">
                                    ...
                                    <asp:Button ID="btnBulkUpload" runat="server" Text="Upload" CssClass="btn btn-flat btn-primary" OnClick="btnBulkUpload_Click" />
