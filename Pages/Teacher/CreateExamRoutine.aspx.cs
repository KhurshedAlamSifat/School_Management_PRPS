...
public partial class Pages_Teacher_CreateExamRoutine : BasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gr in Gridview1.Rows)
        {
            ...
            dt.Rows.Add(period++, ddl1.SelectedValue, box1.Text, box2.Text, examDate);
        }
        if (dt.Rows.Count > 0)
        {
            objRoutine.ExamRoutineInsert(dt, Convert.ToInt32(ddlYear.SelectedItem.Text), Convert.ToInt32(ddlClass.SelectedValue), Convert.ToInt32(ddlGroup.SelectedValue),
