        ...
        <div class="panel-body">
            <asp:GridView ID="gvList" runat="server" CssClass="table table-striped dt-responsive display" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Current Waiver %">
                        <ItemTemplate>
                            <asp:Label ID="lbl_Mapping_Id" runat="server" Text='<%#Eval("Mapping_Id") %>' Visible="false"></asp:Label>
                            <asp:Label ID="lbl_Mapping_WaiverPercentage_old" runat="server" Text='<%#Eval("Mapping_WaiverPercentage") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="New Waiver%" ControlStyle-Width="50px">
                        <ItemTemplate>
                            <asp:TextBox ID="tbx_NewPercentage" runat="server" oninput="tbx_NewPercentageOnInput(this.id)"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="New Amount" ControlStyle-Width="50px">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="tbx_Mapping_AppliedAmount_New" Style="border: 0px" runat="server" Text='<%#Eval("Fee_DefaultAmount") %>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="Server">
    <script type="text/javascript">
        function tbx_NewPercentageOnInput(tbx_NewPercentage_id) {
            let _NewPercentage = document.getElementById(tbx_NewPercentage_id).value;
            let NewPercentage = Number(_NewPercentage);

            let _DefaultAmount = document.getElementById(tbx_NewPercentage_id.replace('cphMain_gvList_tbx_NewPercentage', 'cphMain_gvList_lbl_Fee_DefaultAmount')).innerHTML;
            let DefaultAmount = Number(_DefaultAmount);

            let AppliedAmount_New = (DefaultAmount / 100) * (100 - NewPercentage);

            document.getElementById(tbx_NewPercentage_id.replace('cphMain_gvList_tbx_NewPercentage', 'cphMain_gvList_tbx_Mapping_AppliedAmount_New')).value = AppliedAmount_New;
        }
    </script>
</asp:Content>
