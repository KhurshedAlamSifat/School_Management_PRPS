<%@ Page Title="<%$ Resources:Application,Quota %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Quota.aspx.cs" Inherits="Pages_Admin_Quota" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-1">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,Quota %>"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxName" runat="server" placeholder="Enter Quota Name" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator2" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Quota Name" ControlToValidate="tbxName">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-1">
                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,QuotaPercent %>"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxPercent" runat="server" placeholder="Enter Quota Name" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator1" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Quota Name" ControlToValidate="tbxName">*</asp:RequiredFieldValidator>
                        <cc1:FilteredTextBoxExtender ID="fteVacancyNumber" runat="server" TargetControlID="tbxPercent" ValidChars=".0123456789"></cc1:FilteredTextBoxExtender>
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="box">
                            <div class="box-body">
                                <asp:Repeater ID="rptYear" runat="server">
                                    <HeaderTemplate>
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,Quota %>"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Application,QuotaPercent %>"></asp:Label></th>
                                                    <th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td><%#Eval("QuotaName") %></td>
                                            <td><%#Eval("QuotaPercent") %></td>
                                            <td>
