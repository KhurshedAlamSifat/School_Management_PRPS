                            ...
                            <asp:Repeater ID="rptUser" runat="server">
                                <HeaderTemplate>
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,UserName %>"></asp:Label></th>
                                                <th><asp:Label ID="Label6" runat="server" Text="<%$ Resources:Application,Role %>"></asp:Label></th>
                                                <th><asp:Label ID="Label7" runat="server" Text="<%$ Resources:Application,Email %>"></asp:Label></th>
                                                <th><asp:Label ID="Label8" runat="server" Text="<%$ Resources:Application,Action %>"></asp:Label></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%#Eval("Email") %></td>
                                        <td>
                                            <asp:ImageButton ID="btnEdit" runat="server" OnCommand="btnEdit_Command" CommandArgument='<%# Eval("UserName")%>' ImageUrl="~/Images/Common/edit.png" ToolTip="Edit" />
