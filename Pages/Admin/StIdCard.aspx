<%@ Page Title="Print ID Card" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="StIdCard.aspx.cs" Inherits="Pages_Admin_StIdCard" %>
            ...
            <asp:Repeater ID="rpt" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("Shift") %></td>
                        <td>
                            <a href='<%#string.Concat("/Report/Viewer/IdCard.aspx?Id=",Eval("RegistrationNo")) %>'  target="_blank"><i class="fa fa-2x fa-eye"></i></a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </tbody>
