...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="row">
        <div class="col-sm-8">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4"><asp:Label ID="Label6" runat="server" Text="<%$ Resources:Application,Section %>"></asp:Label><span class="required">*</span></label>
                                        <div class="col-sm-8">
                                            <asp:DropDownList ID="ddlSection" runat="server" DataTextField="Section" DataValueField="Id" CssClass="form-control dropdown"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4"><asp:Label ID="Label7" runat="server" Text="<%$ Resources:Application,Roll %>"></asp:Label><span class="required">*</span></label>
                                        <div class="col-sm-8">
                ...
                <div class="col-sm-12">
                    ...
                    <div class='<%= Common.SessionInfo.Panel %>'>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-5">
                                    <asp:ListBox ID="list1" ClientIDMode="Static" runat="server" class="form-control" Height="280px" DataTextField="SubjectName" DataValueField="Id"></asp:ListBox>
                                </div>
                                <div class="col-sm-7">
                                    <div class="row">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-9">
                                                <asp:ListBox ID="list3" runat="server" ClientIDMode="Static" CssClass="form-control" Height="50px"></asp:ListBox>
            ...
            <asp:Button ID="btnAssign" runat="server" CssClass="btn btn-primary btn-lg pull-right" Text="<%$ Resources:Application,Assign %>" OnClick="btnAssign_Click" />
        </div>
        <div class="col-sm-4">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,Roll %>"></asp:Label></th>
