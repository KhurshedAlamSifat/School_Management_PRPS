...
public partial class Pages_Email_EmailTemplete : BasePage
{
    ...
    {
        string url = "/Pages/Email/" + Path.GetFileName(Request.PhysicalPath) + Request.Url.Query;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            ID = obj.Insert(txtTemplateName.Text, txtSubject.Text, tbxVariables.Text, tbxDetails.Content);
            if (ID != -1)
        ...
        {
            obj.Update(ID, txtTemplateName.Text, txtSubject.Text, tbxVariables.Text, tbxDetails.Content);
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            tbxDetails.Content = dt.Rows[0]["Body"].ToString();
        }
        btnSave.Text = "Edit";
