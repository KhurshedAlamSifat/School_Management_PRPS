...
public partial class Pages_Admin_Class : BasePage
{
    ...
    {
        ID = obj.Insert(tbxName.Text,Convert.ToInt32(tbxNumeric.Text));
        if (ID != -1)
        {
            tbxName.Text = "";
    ...
    {
        obj.Update(ID, tbxName.Text, Convert.ToInt32(tbxNumeric.Text));
        tbxName.Text = "";
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            tbxNumeric.Text = dt.Rows[0]["ClassNumber"].ToString();
        }
