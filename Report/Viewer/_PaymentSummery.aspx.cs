...
public partial class Report_Viewer_PaymentSummery : BasePage
{
    ...
    protected string GetCriteria()
    {
        ...
        {
            criteria += " and Year=" + ddlYear.SelectedValue;
        }
        if (ddlMonth.SelectedValue != "0")
        {
            criteria += " and Month=" + ddlMonth.SelectedValue;
        }
    ...
    {
        DataTable dt = objPayment.GetPaymentSummery(GetCriteria());
        rpt.DataSource = dt;
        rpt.DataBind();
    }
