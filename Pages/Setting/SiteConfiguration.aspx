<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SiteConfiguration.aspx.cs" Inherits="Pages_Setting_SiteConfiguration" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator6" runat="server" ValidationGroup="Getway"
                                    ErrorMessage="Enter Password." ControlToValidate="tbxEstd">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                </div>
