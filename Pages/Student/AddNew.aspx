<%@ Page Title="Add Student" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AddNew.aspx.cs" Inherits="Pages_Student_AddNew" %>
                ...
                <div class="panel-body tab-content panel-body-padding-none">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-horizontal">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <asp:DropDownList ID="ddlClass" runat="server" DataTextField="ClassName" AutoPostBack="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged" DataValueField="Id" CssClass="form-control dropdown"></asp:DropDownList>
                                                                <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator17" runat="server" ValidationGroup="basic"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-4">
                                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:Application,BloodGroup %>"></asp:Label></label>
                                                            <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-4">
                                                                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Application,Email %>"></asp:Label></label>
                                                            <div class="col-sm-6">
                                                                <asp:TextBox ID="tbxEmail" runat="server" CssClass="form-control" placeholder="Enter Email Address"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <asp:TextBox ID="tbxRegNo" runat="server" placeholder="Enter Registration No." CssClass="form-control" ClientIDMode="Static" ReadOnly="true"></asp:TextBox>
                    ...
                    <div class="tab-pane fade in" id="tab2">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator22" runat="server" ValidationGroup="classInfo"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel-footer">
                                    <asp:Button ID="btnClassInfo" runat="server" CssClass="btn btn-primary btn-flat" Text="Save and Continue" OnClick="btnClassInfo_Click" ValidationGroup="classInfo" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator21" runat="server" ValidationGroup="parent"
                                                            ErrorMessage="Enter Father Educational Qualification" ControlToValidate="ddlFatherEdu">*</asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator23" runat="server" ValidationGroup="parent"
                                                            ErrorMessage="Enter Father Profession" ControlToValidate="ddlFatherPro">*</asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator26" runat="server" ValidationGroup="parent"
                                                            ErrorMessage="Enter Mother Educational Qualification" ControlToValidate="ddlMotherEdu">*</asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator24" runat="server" ValidationGroup="parent"
                                                            ErrorMessage="Enter Mother Profession" ControlToValidate="ddlMotherPro">*</asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
