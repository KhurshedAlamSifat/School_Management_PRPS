                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4"><asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,Class %>"></asp:Label></label>
                                        <div class="col-sm-8">
                                    ...
                                    <asp:UpdatePanel ID="updSubject" runat="server">
                                        <ContentTemplate>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4"><asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,Subject %>"></asp:Label></label>
                                                <div class="col-sm-8">
                    ...
                    <div class='<%= Common.SessionInfo.Panel %>'>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4"><asp:Label ID="Label3" runat="server" Text="<%$ Resources:Application,SubjectiveMarks %>"></asp:Label></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4"><asp:Label ID="Label4" runat="server" Text="<%$ Resources:Application,ObjectiveMarks %>"></asp:Label></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4">Practical</label>
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="tbxPractical" runat="server" Placeholder="Enter Objective Fail Practical" CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator3" runat="server" ValidationGroup="save"
                                                ErrorMessage="Enter Objective Practical Marks" ControlToValidate="tbxPractical">*</asp:RequiredFieldValidator>
                            ...
                            <asp:Repeater ID="rptFailSystem" runat="server">
                                <HeaderTemplate>
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><asp:Label ID="Label12" runat="server" Text="<%$ Resources:Application,Class %>"></asp:Label></th>
                                                <th><asp:Label ID="Label1" runat="server" Text="<%$ Resources:Application,Group %>"></asp:Label></th>
                                                <th><asp:Label ID="Label10" runat="server" Text="<%$ Resources:Application,SubjectName %>"></asp:Label></th>
                                                <th><asp:Label ID="Label8" runat="server" Text="<%$ Resources:Application,SubjectivePassMarks %>"></asp:Label></th>
                                                <th><asp:Label ID="Label11" runat="server" Text="<%$ Resources:Application,ObjectivePassMarks %>"></asp:Label></th>
                                                <th>Practical</th>
                                                <th><asp:Label ID="Label9" runat="server" Text="<%$ Resources:Application,Action %>"></asp:Label></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                </HeaderTemplate>
